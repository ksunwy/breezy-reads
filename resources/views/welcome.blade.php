<x-layout>
    <section class="relative w-full flex items-center bg-blue-200 h-[92.46rem]">
        <div class="absolute top-1/2 left-[70%] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center gap-x-20 w-[65rem] h-[63rem] bg-[#191D21] rounded-2xl z-10">
        ...
        <div class="relative flex flex-col gap-[4.36rem] w-[71.4rem] ml-[10%] z-20">
    ...
    <section class="h-[46.23rem] w-full px-[8.56rem] py-[5.22rem] flex flex-col items-center gap-[7.1rem]">
        <div class="grid grid-cols-4 gap-[9.93rem]">
        ...
        <div class="flex items-center gap-[9.93rem]">
            <a href="/" class="bg-transparent poppins-semibold text-[2.39rem] px-[9.16rem] py-[1.37rem] flex items-center justify-center text-center rounded-sm border-[#191D21] border-solid border-2 transition-all duration-300 hover:bg-[#191D21] hover:text-white">Каталог</a>
            <a href="/login" class="bg-[#191D21] text-white poppins-semibold text-[2.39rem] px-[9.16rem] py-[1.37rem] flex items-center justify-center text-center rounded-sm border-[#191D21] border-solid border-2 transition-all duration-300 hover:bg-white hover:text-[#191D21]">Войти</a>
        </div>
    </section>
    ...
    <section class="h-[46.23rem] w-full px-[8.56rem] py-[5.22rem] flex flex-col items-center justify-center gap-[7.1rem] bg-[#FFDBF5]">
        ...
        <div class="flex items-center gap-[6.59rem] flex-nowrap overflow-x-scroll max-w-[164.38356164rem] px-40">
    ...
    <section class="relative flex items-center justify-center h-[92.46rem]">
        <div class="bg-[#FFD1B6] rounded-[1.71rem] w-[123.63rem] h-[64.46rem] flex flex-col gap-12 pt-[3.85rem] pl-[7.61rem] pr-[6.33rem]">
            ...
            <div class="flex items-center gap-3">
                <div class="flex items-center gap-[1.71rem] flex-nowrap overflow-x-scroll max-w-[76.369rem]">
                    ...
                    <div class="flex flex-col gap-[1.24rem] rounded-2xl min-w-[20.54rem] min-h-[32.36rem] bg-[{{ $i->color }}]">
                        ...
                        <div class="flex flex-col gap-[1.5rem] px-[1.37rem]">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="" class="bg-white border border-solid border-[#191D21] h-10 flex items-center justify-center poppins-semibold px-[2.22rem] text-[1.2rem] rounded-sm">Узнать больше</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
    ...
    <section class="relative flex flex-col gap-16 items-center w-full h-[92.46rem]">
        <h2 class="text-center tracking-[-1px] text-[3.76rem] poppins-bold">Скидки</h2>
        <div class="grid grid-cols-5 gap-[8.04rem]">
    ...
    <section class="relative flex flex-col gap-[12.67rem] items-center justify-center h-[92.46rem] w-full bg-[#DED2F9]">
        <h2 class="text-center tracking-[-1px] text-[3.76rem] poppins-bold">Наши последние статьи</h2>
        <div class="grid grid-cols-3 gap-[4.45rem]">
